    ...
    <div
      ...
      style="
          background: url('../../assets/images/big/auth-bg.jpg') no-repeat center
            center;
        ">
      <div class=" mt-4 w-100 p-4 bg-white rounded">
        <div>
          <div class="logo text-center">
            <span class="db"> <img class ="logo-img" src="../../assets/images/company-txt-color.png" style="width: 350px;height: 75px;" alt="logo" /></span>
