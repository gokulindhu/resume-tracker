      ...
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
          <a
            ...
            href="/permissions"
            aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span>Permission List</span></a>
        <li class="sidebar-item">
          <a
            class="sidebar-link waves-dark"
            href="/roles"
            aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span>Role List</span></a>
