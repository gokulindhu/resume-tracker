...
<html dir="ltr">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="16x16"
      href="../../assets/images/custom-select.png"
    />
    ...
    <div class="main-wrapper">
      ...
      >
        <div class="auth-box p-4 bg-white rounded">
          <div id="loginform">
            <!-- <div class="logo"> -->
              <img class ="logo-img" src="../../assets/images/company-txt-color.png" alt="logo"  style="width: 350px;height: 75px;"/>
              <h3 class="box-title mb-3 mt-3 text-center">Sign In as Admin</h3>
              <p class="text-center fw-bold">Resume Tracker</p>
            <!-- </div> -->
            <!-- Form -->
            <div class="row">
              <div class="col-12">
